...
export default function AudienceSection() {
  ...
  return (
    <div className="bg-white overflow-hidden px-4 sm:px-4 md:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
      {/* Mobile Layout */}
      {isMobile ? (
        <div className="flex flex-col gap-6">
          ...
          <div className="w-full flex items-center justify-center mb-4">
            <div className="w-full px-8 h-56 rounded-2xl overflow-hidden relative transition-all duration-500">
              <img
                src="/image-three.png"
